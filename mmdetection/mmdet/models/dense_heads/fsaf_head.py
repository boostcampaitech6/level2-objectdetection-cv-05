...
class FSAFHead(RetinaHead):
    ...
    def _get_targets_single(
        ...
        label_weights = anchors.new_zeros(
            (num_valid_anchors, label_channels), dtype=torch.float
        )
    ...
    def collect_loss_level_single(
        self, cls_loss, reg_loss, assigned_gt_inds, labels_seq
    ):
    ...
    def reweight_loss_single(
        self, cls_loss, reg_loss, assigned_gt_inds, labels, level, min_levels
    ):
