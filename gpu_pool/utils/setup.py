...
INSTALL_REDIS_FAIL_MESSAGE: Final = "redis 설치 중 오류가 발생했습니다. log를 확인해 주세요, WARNING일 경우 설치 완료된 것입니다."
SET_CONFIG_FAIL_MESSAGE: Final = "redis.conf 생성 중 오류가 발생했습니다. log를 확인해 주세요, WARNING일 경우 설치 완료된 것입니다."
